        ...
        table_sql = {
            ...
            'account_transaction': """
                CREATE TABLE IF NOT EXISTS account_transaction (
                    ...
                    transaction_type VARCHAR(20) NOT NULL COMMENT '存款/取款/转账/消费/还款/投资购买/投资赎回',
                    amount DECIMAL(18, 2) NOT NULL,
                    transaction_date DATE NOT NULL,
                    transaction_time TIME NOT NULL,
                    status VARCHAR(20) NOT NULL COMMENT '成功/失败/处理中/撤销',
            ...
            'loan_record': """
                CREATE TABLE IF NOT EXISTS loan_record (
                    ...
                    disbursal_date DATE,
                    due_date DATE,
                    payment_frequency VARCHAR(20) COMMENT '月付/季付/半年付/年付',
            ...
            'investment_record': """
                CREATE TABLE IF NOT EXISTS investment_record (
                    ...
                    risk_level VARCHAR(10) COMMENT '低/中/高',
                    channel VARCHAR(20),
                    create_time DATETIME DEFAULT CURRENT_TIMESTAMP,
                    update_time DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
                    INDEX idx_customer_id (customer_id),
            ...
            'customer_event': """
                CREATE TABLE IF NOT EXISTS customer_event (
                    ...
                    event_type VARCHAR(50) NOT NULL COMMENT '购买事件/借款事件/理财事件',
            ...
            'channel_profile': """
                CREATE TABLE IF NOT EXISTS channel_profile (
                    ...
                    has_online_banking BOOLEAN NOT NULL,
                    has_phone_banking BOOLEAN NOT NULL,
                    online_frequency INT,
                    branch_visit_frequency INT,
